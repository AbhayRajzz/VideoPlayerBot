...
async def start(client, message):
   buttons = [
            ...
            [
                InlineKeyboardButton("📢 CHANNEL", url=f"https://t.me/AbhayRajz"),
                InlineKeyboardButton("SOURCE 📦", url=f"https://Xnxx.com"),
            ],
            [
    ...
    if query.data=="help":
        buttons = [
            [
                ...
                InlineKeyboardButton ("SUPPORT 💬", url=f"https://t.me/JabraSRKians"),
            ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        try:
